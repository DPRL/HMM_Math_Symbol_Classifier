...
function y_position = normalized_y_position(all_point_coordinate)

coordinates = all_point_coordinate;
co_length = size(coordinates,1);
normalized_y_coordinate = zeros(co_length,1);

for i = 1: co_length
    
    normalized_y_coordinate(i,1) = coordinates(i,2);
    
end

y_position = normalized_y_coordinate;
